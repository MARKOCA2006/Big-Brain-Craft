...
public class SilverOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silver_ore_block")
	public static final Block block = null;
	public SilverOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 49);
	}
