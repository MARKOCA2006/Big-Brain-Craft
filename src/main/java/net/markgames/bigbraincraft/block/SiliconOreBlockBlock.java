...
public class SiliconOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silicon_ore_block")
	public static final Block block = null;
	public SiliconOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 40);
	}
