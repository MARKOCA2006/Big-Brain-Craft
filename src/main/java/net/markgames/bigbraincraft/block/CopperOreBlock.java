...
public class CopperOreBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(BigbraincraftModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(4.2f, 6.544439133039291f).lightValue(0)
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 10)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(7, 1, 1, 50))));
		}
	}
}
