...
public class RubyOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:ruby_ore_block")
	public static final Block block = null;
	public RubyOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 89);
	}
