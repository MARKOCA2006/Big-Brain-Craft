...
import net.markgames.bigbraincraft.item.SiliconDustItem;
...
public class SiliconOreBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silicon_ore")
	public static final Block block = null;
	public SiliconOreBlock(BigbraincraftModElements instance) {
		super(instance, 39);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SiliconDustItem.block, (int) (3)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("silicon_ore", "silicon_ore", blockAt -> {
