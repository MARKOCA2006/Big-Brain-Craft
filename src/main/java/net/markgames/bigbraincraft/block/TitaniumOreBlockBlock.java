...
public class TitaniumOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:titanium_ore_block")
	public static final Block block = null;
	public TitaniumOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 61);
	}
