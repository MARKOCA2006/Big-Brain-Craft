...
import net.markgames.bigbraincraft.procedures.DrillUpdateTickProcedure;
import net.markgames.bigbraincraft.itemgroup.BigBrainTabItemGroup;
import net.markgames.bigbraincraft.gui.DrillGUIGui;
...
public class DrillBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:drill")
	public static final Block block = null;
	@ObjectHolder("bigbraincraft:drill")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public DrillBlock(BigbraincraftModElements instance) {
		super(instance, 298);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				DrillUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
