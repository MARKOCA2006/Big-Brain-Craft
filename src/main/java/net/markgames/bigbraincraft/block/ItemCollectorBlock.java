...
import net.markgames.bigbraincraft.procedures.ItemCollectorUpdateTickProcedure;
...
public class ItemCollectorBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:item_collector")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("item_collector");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ItemCollectorUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
	}
