...
public class CobaltOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:cobalt_ore_block")
	public static final Block block = null;
	public CobaltOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobalt_ore_block");
		}
