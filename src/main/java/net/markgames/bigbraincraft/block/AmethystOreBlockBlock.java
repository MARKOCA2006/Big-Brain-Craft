...
public class AmethystOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:amethyst_ore_block")
	public static final Block block = null;
	public AmethystOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 268);
	}
