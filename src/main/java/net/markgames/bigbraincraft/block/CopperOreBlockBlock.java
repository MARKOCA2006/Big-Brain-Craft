...
public class CopperOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:copper_ore_block")
	public static final Block block = null;
	public CopperOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 13);
	}
