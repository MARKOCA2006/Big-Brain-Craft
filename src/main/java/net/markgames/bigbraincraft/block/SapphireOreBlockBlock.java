...
public class SapphireOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:sapphire_ore_block")
	public static final Block block = null;
	public SapphireOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 247);
	}
