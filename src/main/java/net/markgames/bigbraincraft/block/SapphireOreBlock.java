...
import net.markgames.bigbraincraft.item.SapphireGemItem;
...
public class SapphireOreBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:sapphire_ore")
	public static final Block block = null;
	public SapphireOreBlock(BigbraincraftModElements instance) {
		super(instance, 246);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 3)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(4, 1, 1, 50))));
		}
	}
}
