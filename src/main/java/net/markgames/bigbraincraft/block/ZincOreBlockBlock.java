...
public class ZincOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:zinc_ore_block")
	public static final Block block = null;
	public ZincOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("zinc_ore_block");
		}
