...
public class AluminiumOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:aluminium_ore_block")
	public static final Block block = null;
	public AluminiumOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 31);
	}
