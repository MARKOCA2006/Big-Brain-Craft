...
public class UraniumOreBlockBlock extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:uranium_ore_block")
	public static final Block block = null;
	public UraniumOreBlockBlock(BigbraincraftModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("uranium_ore_block");
		}
