...
public class UraniumHoeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:uranium_hoe")
	public static final Item block = null;
	public UraniumHoeItem(BigbraincraftModElements instance) {
		super(instance, 86);
	}
