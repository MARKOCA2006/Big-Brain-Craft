...
public class AluminiumAxeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:aluminium_axe")
	public static final Item block = null;
	public AluminiumAxeItem(BigbraincraftModElements instance) {
		super(instance, 34);
	}
