...
public class AluminiumIngotItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:aluminium_ingot")
	public static final Item block = null;
	public AluminiumIngotItem(BigbraincraftModElements instance) {
		super(instance, 32);
	}
