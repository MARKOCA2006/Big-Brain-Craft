...
public class CopperAxeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:copper_axe")
	public static final Item block = null;
	public CopperAxeItem(BigbraincraftModElements instance) {
		super(instance, 16);
	}
