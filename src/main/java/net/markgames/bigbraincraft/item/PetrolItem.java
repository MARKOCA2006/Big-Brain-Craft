...
public class PetrolItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:petrol")
	public static final Item block = null;
	public PetrolItem(BigbraincraftModElements instance) {
		super(instance, 306);
	}
