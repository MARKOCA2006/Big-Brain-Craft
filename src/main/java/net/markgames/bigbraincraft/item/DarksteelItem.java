...
public class DarksteelItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:darksteel")
	public static final Item block = null;
	public DarksteelItem(BigbraincraftModElements instance) {
		super(instance, 4);
	}
