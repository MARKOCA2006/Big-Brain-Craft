...
public class ZincHoeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:zinc_hoe")
	public static final Item block = null;
	public ZincHoeItem(BigbraincraftModElements instance) {
		super(instance, 76);
	}
