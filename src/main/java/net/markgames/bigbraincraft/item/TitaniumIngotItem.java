...
public class TitaniumIngotItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:titanium_ingot")
	public static final Item block = null;
	public TitaniumIngotItem(BigbraincraftModElements instance) {
		super(instance, 62);
	}
