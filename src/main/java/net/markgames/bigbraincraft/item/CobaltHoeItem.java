...
public class CobaltHoeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:cobalt_hoe")
	public static final Item block = null;
	public CobaltHoeItem(BigbraincraftModElements instance) {
		super(instance, 28);
	}
