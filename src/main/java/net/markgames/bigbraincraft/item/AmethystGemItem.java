...
public class AmethystGemItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:amethyst_gem")
	public static final Item block = null;
	public AmethystGemItem(BigbraincraftModElements instance) {
		super(instance, 269);
	}
