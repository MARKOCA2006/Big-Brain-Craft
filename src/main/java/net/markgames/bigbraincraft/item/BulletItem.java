...
public class BulletItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:bullet")
	public static final Item block = null;
	public BulletItem(BigbraincraftModElements instance) {
		super(instance, 10);
	}
