...
public class ZincSwordItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:zinc_sword")
	public static final Item block = null;
	public ZincSwordItem(BigbraincraftModElements instance) {
		super(instance, 74);
	}
