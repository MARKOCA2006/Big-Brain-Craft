...
public class AmethystShovelItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:amethyst_shovel")
	public static final Item block = null;
	public AmethystShovelItem(BigbraincraftModElements instance) {
		super(instance, 276);
	}
