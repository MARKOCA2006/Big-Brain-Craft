...
public class SapphireAxeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:sapphire_axe")
	public static final Item block = null;
	public SapphireAxeItem(BigbraincraftModElements instance) {
		super(instance, 253);
	}
