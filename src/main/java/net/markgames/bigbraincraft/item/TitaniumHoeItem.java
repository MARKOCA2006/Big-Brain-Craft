...
public class TitaniumHoeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:titanium_hoe")
	public static final Item block = null;
	public TitaniumHoeItem(BigbraincraftModElements instance) {
		super(instance, 67);
	}
