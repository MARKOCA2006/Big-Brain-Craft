...
public class CopperIngotItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(BigbraincraftModElements instance) {
		super(instance, 14);
	}
