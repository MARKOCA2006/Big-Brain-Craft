...
public class SilverSwordItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silver_sword")
	public static final Item block = null;
	public SilverSwordItem(BigbraincraftModElements instance) {
		super(instance, 53);
	}
