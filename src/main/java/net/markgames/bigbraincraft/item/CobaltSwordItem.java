...
public class CobaltSwordItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:cobalt_sword")
	public static final Item block = null;
	public CobaltSwordItem(BigbraincraftModElements instance) {
		super(instance, 26);
	}
