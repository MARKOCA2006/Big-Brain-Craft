...
public class SilverIngotItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silver_ingot")
	public static final Item block = null;
	public SilverIngotItem(BigbraincraftModElements instance) {
		super(instance, 50);
	}
