...
public class RubyPickaxeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:ruby_pickaxe")
	public static final Item block = null;
	public RubyPickaxeItem(BigbraincraftModElements instance) {
		super(instance, 91);
	}
