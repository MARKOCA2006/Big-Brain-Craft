...
public class SapphireGemItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:sapphire_gem")
	public static final Item block = null;
	public SapphireGemItem(BigbraincraftModElements instance) {
		super(instance, 248);
	}
