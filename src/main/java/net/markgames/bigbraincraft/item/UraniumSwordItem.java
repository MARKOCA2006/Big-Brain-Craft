...
public class UraniumSwordItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:uranium_sword")
	public static final Item block = null;
	public UraniumSwordItem(BigbraincraftModElements instance) {
		super(instance, 84);
	}
