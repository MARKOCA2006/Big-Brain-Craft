...
public class AluminiumSwordItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:aluminium_sword")
	public static final Item block = null;
	public AluminiumSwordItem(BigbraincraftModElements instance) {
		super(instance, 35);
	}
