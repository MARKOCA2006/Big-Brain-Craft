...
public class CobaltShovelItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:cobalt_shovel")
	public static final Item block = null;
	public CobaltShovelItem(BigbraincraftModElements instance) {
		super(instance, 27);
	}
