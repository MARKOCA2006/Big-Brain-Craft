...
public class SilverHoeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silver_hoe")
	public static final Item block = null;
	public SilverHoeItem(BigbraincraftModElements instance) {
		super(instance, 55);
	}
