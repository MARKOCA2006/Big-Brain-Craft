...
public class SilverPickaxeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silver_pickaxe")
	public static final Item block = null;
	public SilverPickaxeItem(BigbraincraftModElements instance) {
		super(instance, 51);
	}
