...
public class CobaltAxeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:cobalt_axe")
	public static final Item block = null;
	public CobaltAxeItem(BigbraincraftModElements instance) {
		super(instance, 25);
	}
