...
public class SapphireSwordItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:sapphire_sword")
	public static final Item block = null;
	public SapphireSwordItem(BigbraincraftModElements instance) {
		super(instance, 254);
	}
