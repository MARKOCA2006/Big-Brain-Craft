...
public class RubyHoeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:ruby_hoe")
	public static final Item block = null;
	public RubyHoeItem(BigbraincraftModElements instance) {
		super(instance, 95);
	}
