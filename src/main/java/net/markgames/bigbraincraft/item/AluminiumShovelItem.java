...
public class AluminiumShovelItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:aluminium_shovel")
	public static final Item block = null;
	public AluminiumShovelItem(BigbraincraftModElements instance) {
		super(instance, 36);
	}
