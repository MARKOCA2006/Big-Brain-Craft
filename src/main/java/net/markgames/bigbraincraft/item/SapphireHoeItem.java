...
public class SapphireHoeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:sapphire_hoe")
	public static final Item block = null;
	public SapphireHoeItem(BigbraincraftModElements instance) {
		super(instance, 256);
	}
