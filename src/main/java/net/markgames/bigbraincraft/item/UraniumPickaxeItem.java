...
public class UraniumPickaxeItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:uranium_pickaxe")
	public static final Item block = null;
	public UraniumPickaxeItem(BigbraincraftModElements instance) {
		super(instance, 82);
	}
