...
public class SilverShovelItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:silver_shovel")
	public static final Item block = null;
	public SilverShovelItem(BigbraincraftModElements instance) {
		super(instance, 54);
	}
