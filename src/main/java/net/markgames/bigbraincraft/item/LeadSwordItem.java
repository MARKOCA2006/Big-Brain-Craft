...
public class LeadSwordItem extends BigbraincraftModElements.ModElement {
	@ObjectHolder("bigbraincraft:lead_sword")
	public static final Item block = null;
	public LeadSwordItem(BigbraincraftModElements instance) {
		super(instance, 101);
	}
